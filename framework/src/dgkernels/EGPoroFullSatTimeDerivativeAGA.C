#include "EGPoroFullSatTimeDerivativeAGA.h"

registerMooseObject("MooseApp", EGPoroFullSatTimeDerivativeAGA);

InputParameters
EGPoroFullSatTimeDerivativeAGA::validParams()
{
...
EGPoroFullSatTimeDerivativeAGA::EGPoroFullSatTimeDerivativeAGA(const InputParameters & parameters)
...
Real
EGPoroFullSatTimeDerivativeAGA::computeQpResidual()
{
...
Real
EGPoroFullSatTimeDerivativeAGA::computeQpJacobian()
{
  return 0.0;
}

Real
EGPoroFullSatTimeDerivativeAGA::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real jac = 0;
  if (jvar == _v_id)
  {
